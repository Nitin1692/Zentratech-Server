...
SECRET_KEY = 'django-insecure-5pn6g31uaf-!2k-@noz^-p%pf!&$(+g96$#6(wz=jho26b&f5*'
...
# Optional: Allow all methods (GET, POST, etc.) from allowed origins
...
CSRF_COOKIE_HTTPONLY = False  # Change to True for added security
